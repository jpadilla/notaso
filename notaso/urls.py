...
urlpatterns = [
    ...
    url(
        r"^universities/", include("notaso.universities.urls", namespace="universities")
    ),
    url(r"^professors/", include("notaso.professors.urls", namespace="professors")),
    url(r"^search/", include("notaso.search.urls", namespace="search")),
    # Static pages
    url(
        r"^legal/$",
        TemplateView.as_view(template_name="static/legal.html"),
        name="legal",
    ),
    # Rest api
